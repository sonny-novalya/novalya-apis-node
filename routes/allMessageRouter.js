...
const routes = [
    ...
    { method: 'post', path: '/get-message-variants', handler: messageController.getMessageVariantData },
    { method: "post", path: "/get-predefined-templates", handler: messageController.getNewTemplateMessagesData},
    { method: "post", path: "/get-template-variants", handler: messageController.getNewTemplatesVariants},
